...
#pragma warning restore BL0007
	...
	/// <summary>
	/// Optional custom buttons (e.g. Run for SQL) rendered before the copy button.
	/// </summary>
	[Parameter]
	public RenderFragment? CustomButtonsContent { get; set; }
	...
	protected override void BuildRenderTree(RenderTreeBuilder builder)
	{
		...
		// Custom buttons (e.g. Run for SQL)
		if (CustomButtonsContent != null)
		{
			builder.AddContent(elementIndex++, CustomButtonsContent);
		}
